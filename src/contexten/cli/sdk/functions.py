...
from contexten.cli.api.schemas import CodemodRunType, RunCodemodOutput
...
@dataclass
class Function:
    """A deployed codegen function that can be run remotely."""
    ...
    def run(self, pr: bool = False, **kwargs) -> RunCodemodOutput:
        ...
        Returns:
            The output from the run, containing:
            - success: bool
