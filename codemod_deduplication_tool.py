...
class DeduplicationEngine:
    ...
    def _remove_duplicates(self):
        ...
        # Remove from graph_sitter where graph_sitter has equivalent/better versions
        ...
        if not self.dry_run:
            print(f"\n📊 Removal summary:")
            print(f"  🗑️ Removed from graph_sitter: {Colors.OKGREEN}{removed_from_codegen}{Colors.ENDC} files")
    ...
    def _update_imports_in_content(self, content: str) -> str:
        ...
        for line in lines:
            ...
            # Handle 'from graph_sitter.X import Y' patterns
            ...
            # Handle 'import graph_sitter.X' patterns
    ...
    def _should_import_from_graph_sitter(self, module_path: str) -> bool:
        ...
        # If the module is kept in codegen, import from graph_sitter
        if module_path in self.keep_in_codegen:
            return False
        
        # If the module is unique to codegen, import from graph_sitter
