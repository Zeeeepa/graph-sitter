...
sidebarTitle: "File"
icon: ""
description: "Represents a generic file. Could represent a source file or a non-code file such as a markdown file or image file."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/file.py#L51-L400" />

### Inherits from
[Editable](/api-reference/core/Editable)
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/File" style={ {fontWeight: "inherit", fontSize: "inherit"} }>File</a></> } description="A property that returns the file object for non-source files." />
...
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> } description="The name of the file." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/File" style={ {fontWeight: "inherit", fontSize: "inherit"} }>File</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/File" style={ {fontWeight: "inherit", fontSize: "inherit"} }>File</a> <span>]</span></> } description=""/>
...
### <span className="text-primary">parse</span>
Parses the file representation into the graph.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/file.py#L311-L322" />

<ParameterWrapper>
<Parameter
    name="ctx"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">CodebaseContext</code> }
    description="The codebase context that the file belongs to."
    defaultValue=""
/>
</ParameterWrapper>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/file.py#L263-L292" />

<ParameterWrapper>
<Parameter
    name="new_name"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> }
    description="The new name for the file. If the new name includes the file extension, it will be used as-is."
    defaultValue=""
/>
</ParameterWrapper>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/file.py#L295-L309" />

<ParameterWrapper>
<Parameter
    name="new_filepath"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> }
    description="The new file path to rename the file to."
    defaultValue=""
/>
</ParameterWrapper>
