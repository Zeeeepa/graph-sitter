---
title: "CatchStatement"
sidebarTitle: "CatchStatement"
icon: ""
description: "Abstract representation catch clause."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/statements/catch_statement.py#L21-L36" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/CatchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CatchStatement</a> <span>] | None</span></> } description="The condition which triggers this clause" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span>[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span>[</span> <a href="/api-reference/core/CatchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CatchStatement</a> <span>],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/CatchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CatchStatement</a> <span>]</span></> } description=""/>
