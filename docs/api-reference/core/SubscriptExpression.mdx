...
sidebarTitle: "SubscriptExpression"
icon: ""
description: "Indexing onto an object (Aka using brackets on an object) Examples: A[]"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/subscript_expression.py#L24-L62" />
...
### <span className="text-primary">indices</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>]</span></> } description="A list of indices used for indexing the object." />

### <span className="text-primary">object</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">Object</code> } description="The object being indexed." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/SubscriptExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SubscriptExpression</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/SubscriptExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SubscriptExpression</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/SubscriptExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SubscriptExpression</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
