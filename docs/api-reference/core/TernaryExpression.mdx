...
sidebarTitle: "TernaryExpression"
icon: ""
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/ternary_expression.py#L21-L78" />
...
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/TernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TernaryExpression</a> <span>] | None</span></> } description="The expression to execute if the condition is false." />

### <span className="text-primary">condition</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/TernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TernaryExpression</a> <span>] | None</span></> } description="The condition expression that determines which branch to execute." />

### <span className="text-primary">consequence</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/TernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TernaryExpression</a> <span>] | None</span></> } description="The expression to execute if the condition is true." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/TernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TernaryExpression</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/TernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TernaryExpression</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/TernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TernaryExpression</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
