...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/symbol_groups/dict.py#L81-L180" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Unpack" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Unpack</a> <span>[</span> <a href="/api-reference/core/Dict" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Dict</a> <span>] | None</span></> } description="An optional unpacking element, if present." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/Dict" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Dict</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/Dict" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Dict</a> <span>]</span></> } description=""/>
