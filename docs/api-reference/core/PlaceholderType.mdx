...
sidebarTitle: "PlaceholderType"
icon: ""
description: "Represents a type that has not been implemented yet."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/placeholder_type.py#L20-L32" />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/PlaceholderType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PlaceholderType</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/PlaceholderType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PlaceholderType</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/PlaceholderType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PlaceholderType</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
