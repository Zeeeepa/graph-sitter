---
title: "GenericType"
sidebarTitle: "GenericType"
icon: ""
description: "Abstract representation of the generic types of the programming language."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/generic_type.py#L29-L76" />

### Inherits from
[NamedType](/api-reference/core/NamedType), [HasName](/api-reference/core/HasName), [Type](/api-reference/core/Type), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)
...
<HorizontalDivider light={true} />
<Attribute type={ <><span>Collection[</span> <a href="/api-reference/core/Type" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Type</a> <span>,</span> <a href="/api-reference/core/GenericType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>GenericType</a> <span>]</span></> } description="Retrieves the generic type parameters associated with this type." />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/GenericType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>GenericType</a> <span>]</span></> } description=""/>
