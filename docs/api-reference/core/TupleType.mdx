...
icon: ""
description: "An abstract representation of a tuple type. For example `[number, number]`."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/tuple_type.py#L24-L57" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/TupleType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TupleType</a> <span>]</span></> } description=""/>
