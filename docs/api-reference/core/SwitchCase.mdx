---
title: "SwitchCase"
sidebarTitle: "SwitchCase"
icon: ""
description: "Abstract representation for a switch case."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/statements/switch_case.py#L22-L43" />

### Inherits from
[BlockStatement](/api-reference/core/BlockStatement), [Statement](/api-reference/core/Statement), [HasBlock](/api-reference/core/HasBlock), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)

## Attributes
<HorizontalDivider />
### <span className="text-primary">code_block</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/CodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CodeBlock</a> <span>| None</span></> } description="The code block contained within the statement, if it exists." />

### <span className="text-primary">condition</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/SwitchCase" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SwitchCase</a> <span>] | None</span></> } description="The condition which triggers this case" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span>[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span>[</span> <a href="/api-reference/core/SwitchCase" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SwitchCase</a> <span>],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/SwitchCase" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SwitchCase</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/SwitchCase" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SwitchCase</a> <span>]</span></> } description=""/>
