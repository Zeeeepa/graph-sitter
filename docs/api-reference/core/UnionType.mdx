---
title: "UnionType"
sidebarTitle: "UnionType"
icon: ""
description: "An abstract representation of a union type. For example `str | None` or `string | number`."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/union_type.py#L24-L57" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/UnionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>UnionType</a> <span>]</span></> } description=""/>
