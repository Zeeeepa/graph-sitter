---
title: "HasBlock"
sidebarTitle: "HasBlock"
icon: ""
description: "An interface for any code object that has a block of code, e.g. a function, class, etc."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/has_block.py#L25-L146" />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/HasBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>HasBlock</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/HasBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>HasBlock</a> <span>]</span></> } description=""/>
