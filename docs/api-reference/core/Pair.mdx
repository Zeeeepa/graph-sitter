...
sidebarTitle: "Pair"
icon: ""
description: "An abstract representation of a key, value pair belonging to a `Dict`."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/symbol_groups/dict.py#L29-L73" />

### Inherits from
[HasValue](/api-reference/core/HasValue), [Editable](/api-reference/core/Editable)
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/Pair" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Pair</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/Pair" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Pair</a> <span>]</span></> } description=""/>
