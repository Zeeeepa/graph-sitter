---
title: "Callable"
sidebarTitle: "Callable"
icon: ""
description: "Any symbol that can be invoked with arguments eg. Function, Class, Decorator, ExternalModule"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/callable.py#L42-L130" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Type" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Type</a> <span>|</span> <a href="/api-reference/core/Placeholder" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Placeholder</a> <span>[</span> <a href="/api-reference/core/Callable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Callable</a> <span>]</span></> } description="The type of value returned by the callable, or a placeholder." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/Callable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Callable</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/Callable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Callable</a> <span>]</span></> } description=""/>
