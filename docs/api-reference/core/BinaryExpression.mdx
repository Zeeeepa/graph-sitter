...
icon: ""
description: "Represents binary expressions, e.g. all of +,-,*,/, as well as boolean operations (and, or) etc."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/binary_expression.py#L25-L132" />
...
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span>]]</span></> } description="Returns all elements in a binary expression chain." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span>] | None</span></> } description="The left operand of the binary expression." />

### <span className="text-primary">operators</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/ExpressionGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExpressionGroup</a> <span>[</span> <a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span>],</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span>]]</span></> } description="Returns a list of operators in a chain of binary operations." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span>] | None</span></> } description="The right operand of the binary expression." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
