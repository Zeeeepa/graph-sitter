...
sidebarTitle: "Tuple"
icon: ""
description: "A tuple object. You can use standard operations to operate on this list (IE len, del, append, insert, etc)"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/symbol_groups/tuple.py#L18-L30" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/Tuple" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Tuple</a> <span>]</span></> } description=""/>
