...
sidebarTitle: "UnaryExpression"
icon: ""
description: "Unary expression which is a single operation on a single operand. eg. -5, !true."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/unary_expression.py#L21-L58" />
...
## Attributes
<HorizontalDivider />
### <span className="text-primary">argument</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/UnaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>UnaryExpression</a> <span>]</span></> } description="The argument of the unary expression" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/UnaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>UnaryExpression</a> <span>]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/unary_expression.py#L47-L58" />
