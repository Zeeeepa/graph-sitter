---
title: "SymbolGroup"
sidebarTitle: "SymbolGroup"
icon: ""
description: "These are groups of symbols that form some kind of logical grouping, like a class or module, that do not follow the traditional tree structure."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/symbol_group.py#L26-L281" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/SymbolGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SymbolGroup</a> <span>]</span></> } description=""/>
