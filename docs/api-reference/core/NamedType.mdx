---
title: "NamedType"
sidebarTitle: "NamedType"
icon: ""
description: "An abstract representation of a named type."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/named_type.py#L26-L75" />

### Inherits from
[HasName](/api-reference/core/HasName), [Type](/api-reference/core/Type), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/NamedType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>NamedType</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/NamedType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>NamedType</a> <span>]</span></> } description=""/>
