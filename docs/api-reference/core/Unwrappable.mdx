---
title: "Unwrappable"
sidebarTitle: "Unwrappable"
icon: ""
description: "An abstract representation of an expression that can be unwrapped. Expressions that can be unwrapped include binary expressions and ternary expressions."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/unwrappable.py#L14-L25" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/Unwrappable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Unwrappable</a> <span>]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/unwrappable.py#L20-L25" />
