...
sidebarTitle: "Number"
icon: ""
description: "A number value. eg. 1, 2.0, 3.14"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/number.py#L14-L28" />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/Number" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Number</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/Number" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Number</a> <span>]</span></> } description=""/>
