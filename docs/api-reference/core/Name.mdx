...
sidebarTitle: "Name"
icon: ""
description: "Editable attribute on any given code objects that has a name. For example, function, classes, global variable, interfaces, attributes, parameters are all composed of a name."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/name.py#L22-L122" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/Name" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Name</a> <span>]</span></> } description=""/>
