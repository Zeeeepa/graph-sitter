...
icon: ""
description: "A boolean value eg. True, False"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/boolean.py#L14-L31" />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/Boolean" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Boolean</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/core/Boolean" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Boolean</a> <span>]</span></> } description=""/>
