---
title: "TSExpressionType"
sidebarTitle: "TSExpressionType"
icon: ""
description: "Type defined by evaluation of an expression"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/expressions/expression_type.py#L18-L29" />

### Inherits from
[TSNamedType](/api-reference/typescript/TSNamedType), [NamedType](/api-reference/core/NamedType), [HasName](/api-reference/core/HasName), [Type](/api-reference/core/Type), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)

## Attributes
<HorizontalDivider />
### <span className="text-primary">expression</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/typescript/TSExpressionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSExpressionType</a> <span>[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>]]</span></> } description="The expression to evaluate that yields the type" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSExpressionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSExpressionType</a> <span>]</span></> } description=""/>
