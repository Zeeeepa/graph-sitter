---
title: "TSIfBlockStatement"
sidebarTitle: "TSIfBlockStatement"
icon: ""
description: "Typescript implementation of the if/elif/else statement block. For example, if there is a code block like: if (condition1) { block1 } else if (condition2) { block2 } else { block3 } This class represents the entire block, including the conditions and nested code blocks."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/statements/if_block_statement.py#L26-L139" />

### Inherits from
[IfBlockStatement](/api-reference/core/IfBlockStatement), [Statement](/api-reference/core/Statement), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)

## Attributes
<HorizontalDivider />
### <span className="text-primary">alternative_blocks</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span>]</span></> } description="Returns a list of alternative if/elif/else blocks for the current block." />

### <span className="text-primary">condition</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span>] | None</span></> } description="The condition expression for the if block. None if the block is an else block." />

### <span className="text-primary">consequence_block</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/typescript/TSCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSCodeBlock</a></> } description="The code block that is executed if the condition is True." />

### <span className="text-primary">else_statement</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span>| None</span></> } description="Returns the else block within the if-statement." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span>]</span></> } description="Returns all function calls within the if block statement and its alternative blocks." />
...
### <span className="text-primary">is_elif_statement</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Determines if the current block is an elif block." />

### <span className="text-primary">is_else_statement</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Determines if the current block is an else block." />

### <span className="text-primary">is_if_statement</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Determines if the current block is a standalone 'if' statement." />

### <span className="text-primary">nested_code_blocks</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/typescript/TSCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSCodeBlock</a> <span>]</span></> } description="Returns all nested code blocks within an if/elif/else statement block." />

### <span className="text-primary">nested_statements</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span>[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span>[</span> <a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span>],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
### <span className="text-primary">elif_statements</span>
Returns all elif blocks within the if block.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/statements/if_block_statement.py#L185-L196" />


<Return return_type={ <><span>list[</span> <a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span>]</span></> } description="A list of elif block statements. Empty list if no elif blocks exist."/>
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/statements/if_block_statement.py#L215-L276" />
