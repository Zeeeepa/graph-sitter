---
title: "TSCommentGroup"
sidebarTitle: "TSCommentGroup"
icon: ""
description: "A group of related symbols that represent a comment or docstring in TypeScript For example: ``` // Comment 1 // Comment 2 // Comment 3 ``` would be 3 individual comments (accessible via `symbols`), but together they form a `CommentGroup` (accessible via `self)."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/symbol_groups/comment_group.py#L14-L127" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/symbol_groups/comment_group.py#L57-L74" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSCommentGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSCommentGroup</a> <span>]</span></> } description=""/>
