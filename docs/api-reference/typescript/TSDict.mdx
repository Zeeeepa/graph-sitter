...
sidebarTitle: "TSDict"
icon: ""
description: "A typescript dict object. You can use standard operations to operate on this dict (IE len, del, set, get, etc)"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/symbol_groups/dict.py#L74-L144" />

### Inherits from
[Dict](/api-reference/core/Dict), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Unpack" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Unpack</a> <span>[</span> <a href="/api-reference/typescript/TSDict" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSDict</a> <span>] | None</span></> } description="An optional unpacking element, if present." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSDict" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSDict</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSDict" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSDict</a> <span>]</span></> } description=""/>
