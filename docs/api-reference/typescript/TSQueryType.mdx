---
title: "TSQueryType"
sidebarTitle: "TSQueryType"
icon: ""
description: "Type query Examples: typeof s"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/expressions/query_type.py#L23-L59" />
...
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str | None</code> } description="Returns the name of the query type." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span>TSType[</span> <a href="/api-reference/typescript/TSQueryType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSQueryType</a> <span>]</span></> } description="The TypeScript type associated with the query." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSQueryType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSQueryType</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSQueryType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSQueryType</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSQueryType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSQueryType</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
