---
title: "TSImport"
sidebarTitle: "TSImport"
icon: ""
description: "Extends Import for TypeScript codebases."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/import_resolution.py#L32-L648" />
...
<Attribute type={ <><a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>| None</span></> } description="The alias of the imported symbol, if one exists." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/typescript/TSFile" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFile</a> <span>| None</span></> } description="Returns the SourceFile that an Import is importing from." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/typescript/TSImportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSImportStatement</a></> } description="The statement that this import is part of." />

### <span className="text-primary">import_type</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/ImportType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ImportType</a></> } description="The type of import, indicating how the symbol is imported." />

### <span className="text-primary">imported_exports</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/Exportable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Exportable</a> <span>]</span></> } description="Returns the enumerated list of exports imported from a module import." />

### <span className="text-primary">imported_symbol</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/typescript/TSSymbol" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSSymbol</a> <span>|</span> <a href="/api-reference/core/ExternalModule" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExternalModule</a> <span>|</span> <a href="/api-reference/typescript/TSFile" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFile</a> <span>|</span> <a href="/api-reference/typescript/TSImport" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSImport</a> <span>| None</span></> } description="Returns the symbol directly being imported, including an indirect import and an External" />

### <span className="text-primary">is_dynamic</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Determines if this import is dynamically loaded based on its parent symbol." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>| None</span></> } description="The module from which the symbol is being imported, if applicable." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/typescript/TSSymbol" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSSymbol</a> <span>|</span> <a href="/api-reference/core/ExternalModule" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExternalModule</a> <span>|</span> <a href="/api-reference/typescript/TSFile" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFile</a> <span>| None</span></> } description="Returns the resolved symbol that the import is referencing." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/typescript/TSFile" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFile</a></> } description="SourceFile that this import resides in." />

### <span className="text-primary">to_file_id</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">NodeId</code> } description="The node ID of the file to which this import belongs." />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/importable.py#L46-L78" />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSImport" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSImport</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSImport" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSImport</a> <span>]</span></> } description=""/>


### <span className="text-primary">get_import_string</span>
Generates an import string for an import statement.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/import_resolution.py#L549-L572" />

<ParameterWrapper>
<Parameter
    name="alias"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str | None</code> }
    description="Alias name for the imported symbol. Defaults to None."
    defaultValue="None"
/>
<Parameter
    name="module"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str | None</code> }
    description="Module name to import from. Defaults to None. If not provided, uses the file's import module name."
    defaultValue="None"
/>
<Parameter
    name="import_type"
    type={ <><a href="/api-reference/core/ImportType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ImportType</a></> }
    description="Type of import (e.g. WILDCARD, NAMED_EXPORT). Defaults to ImportType.UNKNOWN."
...
<Return return_type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> } description="A string representation of the import statement."/>


### <span className="text-primary">get_name</span>
Returns the name node of the object.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/has_name.py#L52-L62" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/editable.py#L906-L922" />
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSImport" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSImport</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>


### <span className="text-primary">insert_after</span>
Inserts code after this node.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/editable.py#L605-L631" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/editable.py#L572-L602" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/import_resolution.py#L185-L200" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/import_resolution.py#L79-L91" />

<ParameterWrapper>
<Parameter
    name="self"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">TSImport</code> }
...
<Return return_type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="True if the import is a default export import, False otherwise."/>


### <span className="text-primary">is_module_import</span>
Determines if an import represents a module-level import.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/import_resolution.py#L59-L76" />

<ParameterWrapper>
<Parameter
    name="self"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">TSImport</code> }
    description="The import object to check."
    defaultValue=""
/>
</ParameterWrapper>


<Return return_type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="True if the import is a module-level import, False otherwise. Returns True for: - Imports of type MODULE, WILDCARD, or DEFAULT_EXPORT - Side effect imports that are not type imports"/>


### <span className="text-primary">is_reexport</span>
Returns true if the Import object is also an Export object.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/import_resolution.py#L546-L555" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/import_resolution.py#L214-L222" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/import_resolution.py#L36-L56" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/import_resolution.py#L225-L235" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/import_resolution.py#L504-L524" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/import_resolution.py#L479-L501" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/import_resolution.py#L201-L279" />

<ParameterWrapper>
<Parameter
    name="base_path"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str | None</code> }
    description="The base path to resolve imports from. If None, uses the codebase's base path"
    defaultValue="None"
/>
</ParameterWrapper>


<Return return_type={ <><span>ImportResolution[</span> <a href="/api-reference/typescript/TSFile" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFile</a> <span>] | None</span></> } description="An ImportResolution object containing the resolved file and symbol, or None if the import could not be resolved (treated as an external module). The ImportResolution contains: - from_file: The file being imported from - symbol: The specific symbol being imported (None for module imports) - imports_file: True if importing the entire file/module"/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/import_resolution.py#L625-L648" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/import_resolution.py#L459-L477" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/has_name.py#L65-L77" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/usable.py#L27-L42" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/usable.py#L46-L76" />
