---
title: "JSXProp"
sidebarTitle: "JSXProp"
icon: ""
description: "Abstract representation of TSX/JSX prop, e.g `<Component prop=\"value\" />`."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/detached_symbols/jsx/prop.py#L23-L116" />
...
<Attribute type={ <><a href="/api-reference/typescript/JSXExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXExpression</a> <span>| None</span></> } description="Retrieves the JSX expression associated with this JSX prop." />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/JSXProp" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXProp</a> <span>]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/detached_symbols/jsx/prop.py#L57-L81" />

<ParameterWrapper>
<Parameter
    name="new_src"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> }
    description="The source code to insert after the prop."
    defaultValue=""
/>
<Parameter
    name="fix_indentation"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool, optional</code> }
    description="Whether to fix the indentation of the inserted code. Defaults to False."
    defaultValue="False"
/>
<Parameter
    name="newline"
...
<Parameter
    ...
    description="The priority of the insertion. Defaults to 0."
    defaultValue="0"
/>
<Parameter
    name="dedupe"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool, optional</code> }
    description="Whether to prevent duplicate insertions. Defaults to True."
    defaultValue="True"
/>
</ParameterWrapper>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/detached_symbols/jsx/prop.py#L84-L109" />

<ParameterWrapper>
<Parameter
    name="new_src"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> }
    description="The source code string to insert before the prop."
    defaultValue=""
/>
<Parameter
    name="fix_indentation"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool, optional</code> }
    description="Whether to adjust the indentation of the inserted code. Defaults to False."
    defaultValue="False"
/>
<Parameter
    name="newline"
...
<Parameter
    name="priority"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">int, optional</code> }
    description="Priority of this insertion relative to others. Defaults to 0."
    defaultValue="0"
/>
<Parameter
    name="dedupe"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool, optional</code> }
    description="Whether to avoid duplicate insertions. Defaults to True."
    defaultValue="True"
/>
</ParameterWrapper>
