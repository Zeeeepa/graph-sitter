---
title: "TSParameter"
sidebarTitle: "TSParameter"
icon: ""
description: "A class representing a TypeScript function parameter with extensive type analysis capabilities. This class provides functionality to inspect and manipulate TypeScript function parameters, including support for destructured parameters, optional parameters, variadic parameters, default values, and type annotations."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/detached_symbols/parameter.py#L26-L187" />
...
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str | None</code> } description="Returns the default value of a parameter." />
...
### <span className="text-primary">is_destructured</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Determines if a parameter is part of an object destructuring pattern." />

### <span className="text-primary">is_optional</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Determines if a parameter is marked as optional in TypeScript." />
...
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Determines if a parameter is variadic (using the rest operator)." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Type" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Type</a> <span>|</span> <a href="/api-reference/core/TypePlaceholder" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TypePlaceholder</a> <span>[</span> <a href="/api-reference/typescript/TSParameter" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSParameter</a> <span>]</span></> } description="The type annotation associated with this node" />
...
### <span className="text-primary">convert_to_interface</span>
Converts a parameter's inline type definition to an interface.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/detached_symbols/parameter.py#L124-L187" />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSParameter" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSParameter</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSParameter" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSParameter</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSParameter" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSParameter</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/detached_symbols/parameter.py#L148-L175" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/detached_symbols/parameter.py#L178-L204" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/detached_symbols/parameter.py#L86-L97" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/interfaces/has_value.py#L23-L35" />
