---
title: "TSReadonlyType"
sidebarTitle: "TSReadonlyType"
icon: ""
description: "Readonly type Examples: readonly s"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/expressions/readonly_type.py#L23-L59" />
...
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str | None</code> } description="Retrieves the name of the type." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span>TSType[</span> <a href="/api-reference/typescript/TSReadonlyType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSReadonlyType</a> <span>]</span></> } description="The underlying TypeScript type associated with this readonly type." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSReadonlyType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSReadonlyType</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSReadonlyType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSReadonlyType</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSReadonlyType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSReadonlyType</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
