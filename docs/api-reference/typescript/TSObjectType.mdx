...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/expressions/object_type.py#L66-L81" />

### Inherits from
[Type](/api-reference/core/Type), [TSDict](/api-reference/typescript/TSDict), [Expression](/api-reference/core/Expression), [Dict](/api-reference/core/Dict), [Editable](/api-reference/core/Editable)
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Unpack" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Unpack</a> <span>[</span> <a href="/api-reference/typescript/TSObjectType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSObjectType</a> <span>] | None</span></> } description="An optional unpacking element, if present." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSObjectType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSObjectType</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSObjectType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSObjectType</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSObjectType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSObjectType</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
