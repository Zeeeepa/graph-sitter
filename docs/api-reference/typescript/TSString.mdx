---
title: "TSString"
sidebarTitle: "TSString"
icon: ""
description: "A TypeScript string node representing both literal strings and template strings. This class handles both regular string literals and template strings in TypeScript, providing functionality to parse and manage template string expressions. It extends the base String class with TypeScript-specific capabilities."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/expressions/string.py#L17-L35" />

### Inherits from
[String](/api-reference/core/String), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)

## Attributes
<HorizontalDivider />
### <span className="text-primary">content</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> } description="The content of the string" />

### <span className="text-primary">content_nodes</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span>Collection[</span> <a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>],</span> <a href="/api-reference/typescript/TSString" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSString</a> <span>]</span></> } description="A collection of string fragments and escape sequences in TS, or a single string content in Python." />

### <span className="text-primary">expressions</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>]]</span></> } description="Embedded expressions in the string, only applicable for templated or formatted strings." />
...
### <span className="text-primary">with_quotes</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> } description="Retrieves the string representation with quotation marks." />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSString" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSString</a> <span>]</span></> } description=""/>
