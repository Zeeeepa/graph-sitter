...
sidebarTitle: "TSPair"
icon: ""
description: "A TypeScript pair node that represents key-value pairs in object literals. A specialized class extending `Pair` for handling TypeScript key-value pairs, particularly in object literals. It provides functionality for handling both regular key-value pairs and shorthand property identifiers, with support for reducing boolean conditions."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/symbol_groups/dict.py#L26-L70" />

### Inherits from
[Pair](/api-reference/core/Pair), [HasValue](/api-reference/core/HasValue), [Editable](/api-reference/core/Editable)
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a></> } description="The key expression of the pair, expected to be of type TExpression." />

### <span className="text-primary">name</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> } description="Returns the source text of the key expression in the pair." />
...
### <span className="text-primary">shorthand</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Indicates whether this pair uses shorthand property syntax." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSPair" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSPair</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSPair" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSPair</a> <span>]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/symbol_groups/dict.py#L64-L70" />
