---
title: "TSTernaryExpression"
sidebarTitle: "TSTernaryExpression"
icon: ""
description: "Any ternary expression in the code where a condition will determine branched execution"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/expressions/ternary_expression.py#L13-L20" />

### Inherits from
[TernaryExpression](/api-reference/core/TernaryExpression), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)

## Attributes
<HorizontalDivider />
### <span className="text-primary">alternative</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/typescript/TSTernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTernaryExpression</a> <span>] | None</span></> } description="The expression to execute if the condition is false." />

### <span className="text-primary">condition</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/typescript/TSTernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTernaryExpression</a> <span>] | None</span></> } description="The condition expression that determines which branch to execute." />

### <span className="text-primary">consequence</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/typescript/TSTernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTernaryExpression</a> <span>] | None</span></> } description="The expression to execute if the condition is true." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSTernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTernaryExpression</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSTernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTernaryExpression</a> <span>]</span></> } description=""/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/typescript/TSTernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTernaryExpression</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/expressions/ternary_expression.py#L35-L58" />

<ParameterWrapper>
<Parameter
    name="bool_condition"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> }
    description="The boolean value to reduce the condition to. If True, keeps the consequence branch. If False, keeps the alternative branch."
    defaultValue=""
/>
<Parameter
    name="node"
    type={ <><a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>| None, optional</span></> }
    description="The node to be edited. Defaults to None."
    defaultValue="None"
/>
</ParameterWrapper>


<Return return_type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">None</code> } description="Modifies the ternary expression in place."/>
