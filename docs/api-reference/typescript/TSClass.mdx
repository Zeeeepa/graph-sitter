...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/class_definition.py#L33-L227" />
...
<Parameter
    name="attribute"
    type={ <><a href="/api-reference/typescript/TSAttribute" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSAttribute</a></> }
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/class_definition.py#L150-L173" />

<ParameterWrapper>
<Parameter
    name="source"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> }
    description="The source code of the attribute to add to the class."
    defaultValue=""
/>
</ParameterWrapper>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/class_definition.py#L134-L147" />

<ParameterWrapper>
<Parameter
    name="source"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> }
    description="The source code to be added to the class body."
    defaultValue=""
/>
</ParameterWrapper>
...
### <span className="text-primary">class_component_to_function_component</span>
Converts a class component to a function component.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/class_definition.py#L225-L227" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/typescript/class_definition.py#L175-L222" />
...
<Parameter
    name="parent_class"
    type={ <><span>str |</span> <a href="/api-reference/typescript/TSClass" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSClass</a></> }
