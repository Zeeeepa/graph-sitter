---
title: "PyDecorator"
sidebarTitle: "PyDecorator"
icon: ""
description: "Extends Decorators for Python codebases."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/detached_symbols/decorator.py#L15-L58" />
...
<Attribute type={ <><a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span>| None</span></> } description="Gets the function call node from the decorator if the decorator is a call." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/python/PyDecorator" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyDecorator</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/python/PyDecorator" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyDecorator</a> <span>]</span></> } description=""/>
