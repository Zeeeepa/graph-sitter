---
title: "PyBreakStatement"
sidebarTitle: "PyBreakStatement"
icon: ""
description: "An abstract representation of a python break statement."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/statements/break_statement.py#L15-L24" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span>[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span>[</span> <a href="/api-reference/python/PyBreakStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyBreakStatement</a> <span>],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/python/PyBreakStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyBreakStatement</a> <span>]</span></> } description=""/>
