---
title: "PyComment"
sidebarTitle: "PyComment"
icon: ""
description: "Abstract representation of python comments"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/statements/comment.py#L28-L162" />

### Inherits from
[Comment](/api-reference/core/Comment), [Statement](/api-reference/core/Statement), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)

## Attributes
<HorizontalDivider />
### <span className="text-primary">comment_type</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/python/PyCommentType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCommentType</a></> } description="Determines the type of Python comment based on its syntax." />
...
### <span className="text-primary">google_style</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Determines if a Python docstring follows Google style formatting." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/python/PyCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCodeBlock</a> <span>]</span></> } description="Returns a list of nested code blocks within the statement." />

### <span className="text-primary">nested_statements</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span>[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span>[</span> <a href="/api-reference/python/PyComment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyComment</a> <span>],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> } description="Returns the text content of the comment." />
...
### <span className="text-primary">clean_comment</span>
Cleans a comment block by removing comment symbols, leading/trailing whitespace, and standardizing indentation.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/statements/comment.py#L140-L162" />

<ParameterWrapper>
<Parameter
    name="comment"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> }
    description="The raw comment block to be cleaned. Can be a single-line comment or multi-line docstring."
    defaultValue=""
/>
</ParameterWrapper>


<Return return_type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> } description="The cleaned comment text with comment symbols and excess whitespace removed."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/statements/comment.py#L98-L111" />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/python/PyComment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyComment</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/python/PyComment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyComment</a> <span>]</span></> } description=""/>


### <span className="text-primary">generate_comment</span>
Converts text content into a Python comment block.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/statements/comment.py#L106-L137" />

<ParameterWrapper>
<Parameter
    name="new_src"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> }
    description="The text content to be converted into a comment."
    defaultValue=""
/>
<Parameter
    name="comment_type"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">PyCommentType</code> }
    description="The type of comment to generate (SINGLE_LINE, MULTI_LINE_QUOTE, or MULTI_LINE_DOUBLE_QUOTE)."
    defaultValue=""
/>
<Parameter
    name="force_multiline"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool, optional</code> }
    description="When True, forces multi-line format even for single-line content. Defaults to False."
    defaultValue=""
/>
<Parameter
    name="google_style"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool, optional</code> }
    description="When True, formats multi-line comments in Google style without newline after opening quotes. Defaults to True."
    defaultValue=""
/>
</ParameterWrapper>


<Return return_type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">str</code> } description="The formatted comment block with appropriate comment syntax."/>
