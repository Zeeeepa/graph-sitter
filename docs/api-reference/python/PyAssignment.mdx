...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/assignment.py#L28-L168" />
...
<Attribute type={ <><a href="/api-reference/python/PyCommentGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCommentGroup</a> <span>| None</span></> } description="Returns the comment group associated with the symbol." />
...
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">int</code> } description="Returns the index of the assignment statement in its parent's code block." />

### <span className="text-primary">inline_comment</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/python/PyCommentGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCommentGroup</a> <span>| None</span></> } description="A property that retrieves the inline comment group associated with a symbol." />
...
### <span className="text-primary">is_local_variable</span>
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">bool</code> } description="Determines if an assignment represents a local variable in the current scope." />
...
<HorizontalDivider light={true} />
<Attribute type={ <span></span> } description="The type of symbol, set to SymbolType.GlobalVar." />

### <span className="text-primary">type</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Type" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Type</a> <span>|</span> <a href="/api-reference/core/TypePlaceholder" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TypePlaceholder</a> <span>[</span> <a href="/api-reference/python/PyAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignment</a> <span>]</span></> } description="The type annotation associated with this node" />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/python/PyAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignment</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/python/PyAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignment</a> <span>]</span></> } description="The code flag object for tracking purposes"/>


### <span className="text-primary">from_named_expression</span>
Creates a MultiExpression from a Python named expression.
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/assignment.py#L47-L71" />

<ParameterWrapper>
<Parameter
    name="ts_node"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">TSNode</code> }
    description="The TreeSitter node representing the named expression."
    defaultValue=""
/>
<Parameter
    name="file_node_id"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">NodeId</code> }
    description="The identifier of the file containing this node."
    defaultValue=""
/>
<Parameter
    name="ctx"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">CodebaseContext</code> }
    description="The codebase context instance."
    defaultValue=""
/>
<Parameter
    name="parent"
    type={ <><a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a></> }
    description="The parent node that contains this expression."
    defaultValue=""
/>
</ParameterWrapper>


<Return return_type={ <><a href="/api-reference/core/MultiExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiExpression</a> <span>[</span> <a href="/api-reference/python/PyAssignmentStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignmentStatement</a> <span>,</span> <a href="/api-reference/python/PyAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignment</a> <span>]</span></> } description="A MultiExpression containing the assignments created from the named expression."/>
...
<Return return_type={ <><span>Sequence[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/python/PyAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignment</a> <span>]]</span></> } description="List of Editable objects representing variable usage nodes matching the given name."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/assignment.py#L153-L173" />


<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span>]]</span></> } description="A sorted list of statement nodes where the variable is used."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/assignment.py#L276-L287" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/assignment.py#L132-L168" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/assignment.py#L198-L215" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/core/assignment.py#L176-L195" />
