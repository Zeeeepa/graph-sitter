---
title: "PyHasBlock"
sidebarTitle: "PyHasBlock"
icon: ""
description: "Extends HasBlock for Python codebases."
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/interfaces/has_block.py#L13-L91" />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/python/PyHasBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyHasBlock</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/python/PyHasBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyHasBlock</a> <span>]</span></> } description=""/>
