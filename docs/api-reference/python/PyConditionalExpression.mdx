---
title: "PyConditionalExpression"
sidebarTitle: "PyConditionalExpression"
icon: ""
description: "Conditional Expressions (A if condition else B)"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/develop/src/graph_sitter/python/expressions/conditional_expression.py#L13-L20" />
...
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/python/PyConditionalExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyConditionalExpression</a> <span>] | None</span></> } description="The expression to execute if the condition is false." />

### <span className="text-primary">condition</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/python/PyConditionalExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyConditionalExpression</a> <span>] | None</span></> } description="The condition expression that determines which branch to execute." />

### <span className="text-primary">consequence</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/python/PyConditionalExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyConditionalExpression</a> <span>] | None</span></> } description="The expression to execute if the condition is true." />
...
<Return return_type={ <><span>list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span>[</span> <a href="/api-reference/python/PyConditionalExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyConditionalExpression</a> <span>]]</span></> } description="A list of Editable objects representing the matching string literals."/>
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/python/PyConditionalExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyConditionalExpression</a> <span>]</span></> } description=""/>
