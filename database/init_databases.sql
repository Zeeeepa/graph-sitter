...
-- =============================================================================
-- This script creates 8 specialized databases with dedicated users and passwords
-- for the graph-sitter system. Each database handles a specific domain.
-- Enhanced with Workflows DB for complete workflow orchestration.
-- =============================================================================
...
CREATE DATABASE workflows_db WITH ENCODING 'UTF8' LC_COLLATE='en_US.UTF-8' LC_CTYPE='en_US.UTF-8';
...
CREATE USER workflows_user WITH PASSWORD 'workflows_secure_2024!';
...
ALTER DATABASE workflows_db OWNER TO workflows_user;
...
GRANT CONNECT ON DATABASE workflows_db TO workflows_user;
...
GRANT CONNECT ON DATABASE workflows_db TO analytics_readonly;
