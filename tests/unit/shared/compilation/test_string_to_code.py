...
def test_syntax_error_raises(monkeypatch):
    codeblock = """
print "syntax error"
"""
...
def test_print_os_environ_raises(monkeypatch):
    codeblock = """
...
def test_print_calls_codebase_log(monkeypatch):
...
def test_set_custom_scope_does_not_raise(monkeypatch):
...
def test_stop_codemod_execution_logs_and_raises(mock_logger, monkeypatch):
    codeblock = """
...
def test_references_import_from_generated_imports_does_not_raise(monkeypatch):
    codeblock = """
...
def test_references_import_not_in_generated_imports_raises_runtime_error(monkeypatch):
    codeblock = """
...
def test_error_during_execution_raises_runtime_error(monkeypatch):
    codeblock = """
...
def test_return_statement_still_returns_locals(monkeypatch):
