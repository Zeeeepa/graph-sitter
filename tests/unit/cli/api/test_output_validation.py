...
class TestOutputValidation:
    """Test output validation in the RestAPI client."""

    def test_run_output_validation(self, api_client, mock_response):
        """Test validation of run output."""
        # Setup mock response
    ...
    def test_run_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of run output with missing fields."""
    ...
    def test_docs_output_validation(self, api_client, mock_response):
        """Test validation of docs output."""
        # Setup mock response
        mock_response.json.return_value = {
    ...
    def test_docs_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of docs output with missing fields."""
        # Setup mock response with missing fields
        mock_response.json.return_value = {
            "docs": {"doc1": "content1"},
        }
    ...
    def test_ask_expert_output_validation(self, api_client, mock_response):
        """Test validation of ask_expert output."""
        # Setup mock response
        mock_response.json.return_value = {
    ...
    def test_ask_expert_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of ask_expert output with missing fields."""
        # Setup mock response with missing fields
        mock_response.json.return_value = {
            "success": True,
        }
    ...
    def test_create_output_validation(self, api_client, mock_response):
        """Test validation of create output."""
        # Setup mock response
        mock_response.json.return_value = {
            "success": True,
    ...
    def test_create_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of create output with missing fields."""
        # Setup mock response with missing fields
        mock_response.json.return_value = {
            "success": True,
            "response": "Creation response",
    ...
    def test_identify_output_validation(self, api_client, mock_response):
        """Test validation of identify output."""
        # Setup mock response
        mock_response.json.return_value = {
            "auth_context": {
                "token_id": 123,
    ...
    def test_identify_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of identify output with missing fields."""
        # Setup mock response with missing fields
        mock_response.json.return_value = {
            "auth_context": {
                "token_id": 123,
    ...
    def test_deploy_output_validation(self, api_client, mock_response):
        """Test validation of deploy output."""
        # Setup mock response
        mock_response.json.return_value = {
            "success": True,
            "new": True,
    ...
    def test_deploy_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of deploy output with missing fields."""
        # Setup mock response with missing fields
        mock_response.json.return_value = {
            "success": True,
            "new": True,
    ...
    def test_lookup_output_validation(self, api_client, mock_response):
        """Test validation of lookup output."""
        # Setup mock response
        mock_response.json.return_value = {
            "codemod_id": 123,
            "version_id": 456,
    ...
    def test_lookup_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of lookup output with missing fields."""
        # Setup mock response with missing fields
        mock_response.json.return_value = {
            "codemod_id": 123,
        }
    ...
    def test_run_on_pr_output_validation(self, api_client, mock_response):
        """Test validation of run_on_pr output."""
        # Setup mock response
        mock_response.json.return_value = {
            "codemod_id": 123,
            "codemod_run_id": 456,
    ...
    def test_run_on_pr_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of run_on_pr output with missing fields."""
        # Setup mock response with missing fields
        mock_response.json.return_value = {
            "codemod_id": 123,
            "codemod_run_id": 456,
    ...
    def test_lookup_pr_output_validation(self, api_client, mock_response):
        """Test validation of lookup_pr output."""
        # Setup mock response
        mock_response.json.return_value = {
            "pr": {
    ...
    def test_lookup_pr_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of lookup_pr output with missing fields."""
        # Setup mock response with missing fields
        mock_response.json.return_value = {}
    ...
    def test_improve_codemod_output_validation(self, api_client, mock_response):
        """Test validation of improve_codemod output."""
        # Setup mock response
        mock_response.json.return_value = {
            "success": True,
    ...
    def test_improve_codemod_output_validation_missing_fields(self, api_client, mock_response):
        """Test validation of improve_codemod output with missing fields."""
        # Setup mock response with missing fields
        mock_response.json.return_value = {
            "success": True,
        }
