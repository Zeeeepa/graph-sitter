...
class TestDebugMode:
    """Test debug mode in the RestAPI client."""
    ...
    def test_debug_mode_enabled_with_input(self, api_client, mock_response):
        """Test that debug mode prints request details with input data."""
        # Enable debug mode
        original_debug = global_env.DEBUG
        global_env.DEBUG = True
